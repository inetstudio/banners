...
namespace InetStudio\BannersPackage\Banners\Http\Responses\Back\Utility;
...
class SuggestionsResponse implements SuggestionsResponseContract
{
    ...
    public function toResponse($request)
    {
        $transformer = app()->make(
            'InetStudio\BannersPackage\Banners\Contracts\Transformers\Back\Utility\SuggestionTransformerContract',
            [
                'type' => $this->type,
            ]
        );
