@inject('groupsService', 'InetStudio\BannersPackage\Groups\Contracts\Services\Back\ItemsServiceContract')
...
{!! Form::dropdown('groups[]', $item->groups()->pluck('id')->toArray(), [
    ...
    'field' => [
        ...
        'style' => 'width: 100%',
        'multiple' => 'multiple',
        'data-source' => route('back.banners-package.groups.getSuggestions'),
