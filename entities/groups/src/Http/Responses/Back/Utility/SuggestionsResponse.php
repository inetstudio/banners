...
namespace InetStudio\BannersPackage\Groups\Http\Responses\Back\Utility;
...
class SuggestionsResponse implements SuggestionsResponseContract
{
    ...
    {
        $transformer = resolve(
            'InetStudio\BannersPackage\Groups\Contracts\Transformers\Back\Utility\SuggestionTransformerContract',
            [
                'type' => $this->type,
            ]
        );
